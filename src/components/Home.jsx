                  ...
                  <div class="">
                    <div>
                      ...
                      <div className="d-flex justify-content-between p-3">
                        ...
                        <img style={{width:"70px", height:"70px"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQK8ffDsJ4jPCqnGI6CmuPG9MHW22ophfZauvpt6qO5qnJz6oKjsySCrmqgrEZLk30ufKs&usqp=CAU" alt="" />
                        <div className='text-start mx-2' style={{fontSize:"12px"}}>
                          <h6 className='fw-bold'>
                            <Link to='/MainProfile'>
                            {user.firstName } {user.lastName} { user.additionalName}
                            </Link>
                            </h6>
                          <h6>{user.industry}</h6>
       ...
       <>
          <div style={{
            ...
            opacity:"0.65"
              ...
              <MediaComponent setShowMediaComponent={setShowMediaComponent} seteventComponent={seteventComponent} eventComponent={eventComponent} showMediaComponent={showMediaComponent} />
      </> : <><div>{null}</div></>}
