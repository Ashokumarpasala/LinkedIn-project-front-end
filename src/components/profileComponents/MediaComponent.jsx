...
function MediaComponent({setShowMediaComponent, showMediaComponent}) {
        ...
        <div class="card-body ">
          ...
          <div className=' h-75 d-flex  align-items-end'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" onClick={openfile}   style={{cursor:"pointer"}} fill="currentColor"  class="bi bi-image mx-3" viewBox="0 0 16 16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-calculator mx-3" viewBox="0 0 16 16">
